...
router.on("user/:id/:action", function (match) {
  document.getElementById("app").innerHTML = "<pre>".concat(JSON.stringify(match, null, 2), "</pre>");
});
router.on('about/contacts', function (match) {
  $('#app').html('about/contacts');
});
},{"navigo":"node_modules/navigo/lib/navigo.min.js","jquery":"node_modules/jquery/dist/jquery.js","./styles.css":"src/styles.css"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
